...
const blog = () => {
  return (
    <Layout>
      <div className="mt-24 px-12 flex flex-wrap justify-between md:px-24 mx-auto container">
        {/* First big post */}
        <div className="md:grid my-2 flex flex-col md:grid-cols-2">
          <img
        ...
        {/* Consequent posts */}
        <div className="flex my-2 border border-white w-full md:w-2/5 flex-col">
          <img
            src="https://source.unsplash.com/bli6Z7xsPGE"
        ...
        <div className="flex border my-2 border-white w-full md:w-2/5 flex-col">
          <img
            src="https://source.unsplash.com/bli6Z7xsPGE"
            className="rounded-lg w-full"
            alt=""
