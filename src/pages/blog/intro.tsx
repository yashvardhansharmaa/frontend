    ...
    <Layout>
      <div className="flex flex-col items-center">
        ...
        <div className="container flex flex-col justify-center items-center my-10">
          <div className="flex justify-start items-start w-full md:px-0 px-5">
            October 26, 2020
          </div>
          <h1 className="md:text-6xl text-4xl my-5 font-heading">
            Montgomery Bus Boycott
          </h1>
        </div>
        <div className="container text-md leading-relaxed font-body">
          ...
          <p className="md:px-0 px-4">
            ...
            Montgomery, Alabama, boarded the city bus. She was the first person
            to challenge the segregation of buses by refusing to give up her
            seat. Colvin was eventually arrested for her refusal and screamed,
            “It’s my constitutional right,” as the police dragged her out of the
            bus. The Black representatives planned to protest using Colvin as
            their leading figure. However, it was discovered that she was
            pregnant and deemed an inappropriate symbol for their cause.
            ...
            three other women (Aurelia S. Browder, Susie McDonald, and Mary
            Louise Smith). In Browder v. Gayle’s case, which ultimately defined
